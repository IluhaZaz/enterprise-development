...
public class CarRentalDataSeed
{
    ...
    public CarRentalDataSeed()
    {
        ...
        ModelGenerations =
        [
            new ModelGeneration { Id = 1, Year = 2020, EngineVolume = 2.5f, ModelId = CarModels[0].Id, TransmissionType = CarTransmissionType.Automatic, PricePerHour = 2000 },
            new ModelGeneration { Id = 2, Year = 2022, EngineVolume = 2.0f, ModelId = CarModels[0].Id, TransmissionType = CarTransmissionType.Automatic, PricePerHour = 2200 },
            new ModelGeneration { Id = 3, Year = 2021, EngineVolume = 3.0f, ModelId = CarModels[1].Id, TransmissionType = CarTransmissionType.Automatic, PricePerHour = 3500 },
            new ModelGeneration { Id = 4, Year = 2019, EngineVolume = 1.6f, ModelId = CarModels[2].Id, TransmissionType = CarTransmissionType.Manual, PricePerHour = 900 },
            new ModelGeneration { Id = 5, Year = 2020, EngineVolume = 1.6f, ModelId = CarModels[3].Id, TransmissionType = CarTransmissionType.AutomatedManual, PricePerHour = 1100 },
            new ModelGeneration { Id = 6, Year = 2022, EngineVolume = 3.0f, ModelId = CarModels[4].Id, TransmissionType = CarTransmissionType.Automatic, PricePerHour = 5000 },
            new ModelGeneration { Id = 7, Year = 2021, EngineVolume = 1.4f, ModelId = CarModels[5].Id, TransmissionType = CarTransmissionType.Manual, PricePerHour = 950 },
            new ModelGeneration { Id = 8, Year = 2023, EngineVolume = 2.0f, ModelId = CarModels[6].Id, TransmissionType = CarTransmissionType.Automatic, PricePerHour = 1800 },
            new ModelGeneration { Id = 9, Year = 2022, EngineVolume = 1.8f, ModelId = CarModels[7].Id, TransmissionType = CarTransmissionType.Automatic, PricePerHour = 1700 },
            new ModelGeneration { Id = 10, Year = 2020, EngineVolume = 1.4f, ModelId = CarModels[5].Id, TransmissionType = CarTransmissionType.ContinuouslyVariable, PricePerHour = 1000 }
        ];

        Cars =
        [
            new Car { Id = 1, GenerationId = ModelGenerations[0].Id,LicensePlate = "A123BC777", Color = Color.Black },
            new Car { Id = 2, GenerationId = ModelGenerations[0].Id, LicensePlate = "B456OP777", Color = Color.White },
            new Car { Id = 3, GenerationId = ModelGenerations[1].Id, LicensePlate = "E789TT777", Color = Color.Silver },
            new Car { Id = 4, GenerationId = ModelGenerations[2].Id, LicensePlate = "K321MM777", Color = Color.Blue },
            new Car { Id = 5, GenerationId = ModelGenerations[2].Id, LicensePlate = "M654HH777", Color = Color.Black },
            new Car { Id = 6, GenerationId = ModelGenerations[3].Id, LicensePlate = "O987PP777", Color = Color.Red },
            new Car { Id = 7, GenerationId = ModelGenerations[3].Id, LicensePlate = "P159CC777", Color = Color.White },
            new Car { Id = 8, GenerationId = ModelGenerations[4].Id, LicensePlate = "C753YY777", Color = Color.Gray },
            new Car { Id = 9, GenerationId = ModelGenerations[5].Id, LicensePlate = "T456FF777", Color = Color.Black },
            new Car { Id = 10, GenerationId = ModelGenerations[5].Id, LicensePlate = "Y789XX777", Color = Color.White },
            new Car { Id = 11, GenerationId = ModelGenerations[6].Id, LicensePlate = "X123KK777", Color = Color.Blue },
            new Car { Id = 12, GenerationId = ModelGenerations[7].Id, LicensePlate = "C456LL777", Color = Color.Green },
            new Car { Id = 13, GenerationId = ModelGenerations[8].Id, LicensePlate = "Z789MM777", Color = Color.Silver },
            new Car { Id = 14, GenerationId = ModelGenerations[9].Id, LicensePlate = "H321HH777", Color = Color.Red }
        ];
